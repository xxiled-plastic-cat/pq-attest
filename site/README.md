...
API and MCP hosts live in [`src/data/site.ts`](src/data/site.ts): `https://api.pqattest.com` and `https://mcp.pqattest.com/mcp`. Contact (`hello@pqattest.example`) is still a placeholder.
