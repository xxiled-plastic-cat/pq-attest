...
## Endpoints
- POST /attest — { "txid": string } — 0.001 USDC. An Algorand source is paid in Algorand USDC. A Base source can be paid in Base USDC or Algorand USDC. A Solana source can be paid in Solana USDC or Algorand USDC.
